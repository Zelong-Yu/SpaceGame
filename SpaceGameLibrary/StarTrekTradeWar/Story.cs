...
namespace StarTrekTradeWar
{
    ...
    public static void DisplayHeader()
        ...
        internal static void DisplayIntro()
        {
            ...
            Console.Clear();
            System.Console.WriteLine("The once forgotten concept of \"Money\" made its way back. The Starfleet has been privatized...");
            Utility.PromptForInput("Press any key to continue");
            Console.Clear();
            System.Console.WriteLine("The Starfleet command secretly orders you, Captain Kirk's grandson, to earn $10,000 space dollars to save the Starfleet from financially ruined, through trading " +
                "unspeakable goods...");
            Utility.PromptForInput("Press any key to continue");
